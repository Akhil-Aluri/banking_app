...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerDetailsDto fetchCustomerDetails(String mobileNumber, String correlationId) {
        ...
        ResponseEntity<LoansDto> loansDtoResponseEntity = loansFeignClient.getLoanDetails(mobileNumber,correlationId);
        if(null != loansDtoResponseEntity) {
            customerDetailsDto.setLoansDto(loansDtoResponseEntity.getBody());
        }
        ResponseEntity<CardsDto> cardsDtoResponseEntity = cardsFeignClient.getCardDetails(mobileNumber, correlationId);
